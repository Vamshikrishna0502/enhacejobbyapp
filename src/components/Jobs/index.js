...
class Jobs extends Component {
  ...
  renderJobsList = () => {
    ...
    if (locationList.length > 0) {
      filteredJobList = jobsList.filter(eachJob =>
        locationList.includes(eachJob.location),
      )
    }
  ...
  changeLocationList = type => {
    ...
    const inputNotInList = locationList.filter(eachItem => eachItem === type)
    // console.log(inputNotInList)
    if (inputNotInList.length === 0) {
      this.setState(
        prevState => ({
      ...
      this.setState({locationList: filteredData}, this.getJobs)
    }
  }
        ...
        <div className="jobs-container">
          <div className="jobs-content">
            <FiltersGroup
              ...
              locationList={locationFilterList}
